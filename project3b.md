...
## 3. Implementation
The instructors will place the circular bullseye as they wish (position with gaussian given). The task is to land on the circular target.  You'll need to implement the following:
